    ...
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px]">
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <h1 className="py-[12px] text-2xl font-medium text-[#172026] lg:text-[42px] lg:leading-[58px]">
          ...
          <p className="py-[24px] text-[#36485C] lg:text-[18px]">
            Stay on top things and revamp your work process with our
            game-changing feature. Get a birds eye view with our customisable
            dashboard.
          </p>
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#0085FF] lg:text-[18ox]">
            Learn More{" "}
            <span>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#00A424] lg:text-[18ox]">
            Learn More{" "}
            <span>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#EB2891] lg:text-[18ox]">
            Learn More{" "}
            <span>
